...
export const twoLegs = [
  defineLegs<TwoLegsCategory, AsJumper>()({
    ...
    ai_summary: 'BAWS製二脚。AP4240、実弾防御362、爆発防御398と高め。姿勢安定824、積載限度62600。ジャンプ距離132、高さ29。EN負荷300と低い。バランス型。',
  ...
  defineLegs<TwoLegsCategory, AsJumper>()({
    ...
    ai_summary: 'BAWS製二脚。AP2000と低め、防御力は標準的。姿勢安定658、積載限度62600。ジャンプ距離132、高さ25。重量18560とやや軽量。価格0の初期装備。',
  ...
  defineLegs<TwoLegsCategory, AsJumper>()({
    ...
    ai_summary: 'ベイラム製二脚。AP4300、実弾防御369と高くバランス良い防御力。姿勢安定843、積載限度60520。ジャンプ距離107、高さ28。重量17960と軽量。バランス型。',
  ...
  defineLegs<TwoLegsCategory, AsJumper>()({
    ...
    ai_summary: 'ベイラム製二脚。AP3980、防御力はバランス良く標準的。姿勢安定835、積載限度55440。ジャンプ距離118、高さ30とやや高め。重量16520と軽量。価格0の初期装備。',
  ...
  defineLegs<TwoLegsCategory, AsJumper>()({
    ...
    ai_summary: '大豊製二脚。AP5300と極めて高く、実弾防御414と最高クラス。姿勢安定925、積載限度82600と極めて高い。ジャンプ性能は低い。重量級向け高防御型。',
  ...
  defineLegs<TwoLegsCategory, AsJumper>()({
    ...
    ai_summary: 'アーキバス製二脚。AP4090、EN防御379と高くEN武器に強い。姿勢安定830、積載限度58620。ジャンプ距離112、高さ29。重量17170と軽量。バランス型。',
  ...
  defineLegs<TwoLegsCategory, AsJumper>()({
    ...
    ai_summary: 'シュナイダー製二脚。AP3500、防御力は低め。姿勢安定711、積載限度48650と低め。ジャンプ距離228、高さ52と極めて高い。重量14030と最軽量級。超高ジャンプ特化型。',
  ...
  defineLegs<TwoLegsCategory, AsJumper>()({
    ...
    ai_summary: 'アーキバス先進開発局製二脚。AP6000と最高クラス、EN防御453と極めて高い。姿勢安定977、積載限度85700と極めて高い。ジャンプ性能は低い。超重量級高性能型。',
    ai_tags: ['二脚', '最高AP', '最高EN防御', 'アーキバス先進開発局', '超重量級'],
  }),
  defineLegs<TwoLegsCategory, AsJumper>()({
    id: 'LG009',
    ...
    ai_summary: 'RaD製二脚。AP3650、防御力は標準的。姿勢安定799、積載限度53700。ジャンプ距離100、高さ27。重量16300、EN負荷280と最低クラス。価格0の初期装備。',
  ...
  defineLegs<TwoLegsCategory, AsJumper>()({
    ...
    ai_summary: 'RaD製二脚。AP5220と高く、爆発防御383と高い。姿勢安定1003と最高クラス、積載限度68900と高い。ジャンプ性能は低い。EN負荷680と高い。重量級向けバランス型。',
  ...
  defineLegs<TwoLegsCategory, AsJumper>()({
    ...
    ai_summary: 'RaD製二脚。AP5450と高く、EN防御408と極めて高い。姿勢安定997、積載限度77100と極めて高い。ジャンプ性能は低い。重量級向け高性能型。',
  ...
  defineLegs<TwoLegsCategory, AsJumper>()({
    ...
    ai_summary: 'エルカノ製二脚。AP3600、防御力は低め。姿勢安定737、積載限度52100。ジャンプ距離120、高さ31と高め。重量11200と最軽量級。超軽量高機動型。',
  ...
  defineLegs<TwoLegsCategory, AsJumper>()({
    ...
    ai_summary: 'エルカノ製二脚。AP3850、三属性防御が全て316と完全にバランス。姿勢安定809、積載限度50100。ジャンプ高さ37と高い。重量13150と軽量。完全バランス型。',
    ai_tags: ['二脚', '完全バランス防御', '高ジャンプ高さ', 'エルカノ', '軽量級'],
  }),
  defineLegs<TwoLegsCategory, AsJumper>()({
    id: 'LG014',
    ...
    ai_summary: 'オールマインド製二脚。AP4560、EN防御390と高くバランス良い防御力。姿勢安定894、積載限度63810。ジャンプ距離103、高さ25。高性能バランス型。',
  ...
  defineLegs<TwoLegsCategory, AsJumper>()({
    ...
    ai_summary: '技研製二脚。AP3800、EN防御352と高くバランス良い防御力。姿勢安定805、積載限度55050。ジャンプ距離109、高さ30。重量15200と軽量。軽量バランス型。',
  ...
  defineLegs<TwoLegsCategory, AsJumper>()({
    ...
    ai_summary: '技研製二脚。AP4120、EN防御380と高くバランス良い防御力。姿勢安定906、積載限度64900。ジャンプ距離115、高さ31と高め。高性能バランス型。',
...
export const reverseJoints = [
  defineLegs<ReverseJointCategory, AsJumper>()({
    ...
    ai_summary: 'シュナイダー製逆関節。AP3580、防御力は低め。姿勢安定686、積載限度47820と低め。ジャンプ距離386、高さ80と最高クラス。重量16510と軽量。超高ジャンプ特化型。',
    ai_tags: ['逆関節', '最高ジャンプ性能', '超高機動', 'シュナイダー', '軽量級'],
  }),
  defineLegs<ReverseJointCategory, AsJumper>()({
    id: 'LG018',
    ...
    ai_summary: 'RaD製逆関節。AP4410、実弾防御406と極めて高い。姿勢安定756、積載限度70360と高い。ジャンプ距離317、高さ70と極めて高い。重量25340と重め。高積載高ジャンプ型。',
  ...
  defineLegs<ReverseJointCategory, AsJumper>()({
    ...
    ai_summary: 'オールマインド製逆関節。AP4020、EN防御360と高くバランス良い防御力。姿勢安定788、積載限度61600。ジャンプ距離334、高さ60と高い。バランス型。',
    ai_tags: ['逆関節', 'バランス型', '高ジャンプ性能', 'オールマインド', '中量級'],
  }),
] as const
...
export const fourLegs = [
  defineLegs<FourLegsCategory, AsJumper>()({
    ...
    ai_summary: 'ベイラム製四脚。AP5250と高く、実弾防御402と高い。姿勢安定1413と極めて高く、積載限度76200と高い。ジャンプ性能は低い。重量36200と超重量級。高安定重量級型。',
  ...
  defineLegs<FourLegsCategory, AsJumper>()({
    ...
    ai_summary: 'アーキバス製四脚。AP4100、EN防御384と高くバランス良い防御力。姿勢安定1366と極めて高く、積載限度69800と高い。ジャンプ距離103と高め。高安定バランス型。',
  ...
  defineLegs<FourLegsCategory, AsJumper>()({
    ...
    ai_summary: 'シュナイダー製四脚。AP3560と低め、防御力も低め。姿勢安定1051と高く、積載限度52460。ジャンプ高さ42と極めて高い。重量22430と四脚では軽量。軽量高ジャンプ型。',
    ai_tags: ['四脚', '高姿勢安定', '最高ジャンプ高さ', 'シュナイダー', '軽量級'],
  }),
] as const
...
export const tanks = [
  defineLegs<TankCategory, AsTank>()({
    ...
    ai_summary: 'ベイラム製タンク。AP9240と最高クラス、実弾防御440、爆発防御399と極めて高い。姿勢安定1500と最高、積載限度100300と最高。移動速度150、推力4667。超重量級最高性能型。',
  ...
  defineLegs<TankCategory, AsTank>()({
    ...
    ai_summary: 'アーキバス先進開発局製タンク。AP8600と高く、EN防御460と最高クラス。姿勢安定924、積載限度91000と高い。推力5984、上昇推力5001と高い。AB推力10502と極めて高い。高機動EN防御型。',
    ai_tags: ['タンク', '高AP', '最高EN防御', 'アーキバス先進開発局', '超重量級'],
  }),
  defineLegs<TankCategory, AsTank>()({
    id: 'LG025',
    ...
    ai_summary: 'エルカノ製タンク。AP4860と低め、防御力も低め。姿勢安定822、積載限度69300。移動速度194、高速性能430と最高クラス。QB推力25000と最高。重量24650とタンクでは最軽量。軽量高速型。',
