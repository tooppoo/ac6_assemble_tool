...
export const fcses = [
  defineFCS({
    ...
    ai_summary: 'ファーロン製FCS。近距離38、中距離27、遠距離20と全距離で標準的。ミサイルロック79、マルチロック40。価格0の初期装備。バランス型。',
  ...
  defineFCS({
    ...
    ai_summary: 'ファーロン製FCS。近距離42、中距離80と極めて高く、遠距離26。ミサイルロック105と高い。中距離戦闘特化型。',
  ...
  defineFCS({
    ...
    ai_summary: 'ファーロン製FCS。近中遠距離アシストは控えめ。ミサイルロック128、マルチロック90と極めて高い。マルチロックミサイル特化型。',
    ai_tags: ['FCS', 'マルチロック特化', 'ミサイル強化', 'ファーロン', '広範囲ロック'],
  }),
  defineFCS({
    id: 'FCS004',
    name: 'FCS-G2/P12SML',
    ...
    ai_summary: 'ファーロン製FCS。近中遠距離アシストは控えめ。マルチロック120と最高クラス、ミサイルロック118も高い。超マルチロック特化型。',
    ai_tags: ['FCS', '最高マルチロック', 'ミサイル強化', 'ファーロン', '最多同時ロック'],
  }),
  defineFCS({
    id: 'FCS005',
    name: 'FC-006 ABBOT',
    ...
    ai_summary: 'ベイラム製FCS。近距離70と極めて高く、中距離32、遠距離5と極めて低い。ミサイルロック74。完全な近距離戦闘特化型。',
  ...
  defineFCS({
    ...
    ai_summary: 'ベイラム製FCS。近距離63、中距離54と高く、遠距離11と低い。ミサイルロック103、マルチロック62。近中距離バランス型。',
  ...
  defineFCS({
    ...
    ai_summary: 'アーキバス先進開発局製FCS。近距離36、中距離67、遠距離92と極めて高い。重量85と最軽量。遠距離狙撃特化型。',
    ai_tags: ['FCS', '遠距離特化', '狙撃向け', 'アーキバス先進開発局', '最軽量'],
  }),
  defineFCS({
    id: 'FCS008',
    name: 'VE-21B',
    ...
    ai_summary: 'アーキバス先進開発局製FCS。近距離15と極めて低く、中距離76、遠距離80と高い。ミサイルロック97、マルチロック70。中遠距離特化型。',
    ai_tags: ['FCS', '中遠距離特化', '遠距離向け', 'アーキバス先進開発局', '中遠距離'],
  }),
  defineFCS({
    id: 'FCS009',
    ...
    ai_summary: '技研製FCS。近距離90と最高クラス、中距離12、遠距離3と極めて低い。ミサイルロック85。超近距離格闘特化型。',
  ...
  defineFCS({
    ...
    ai_summary: '技研製FCS。近距離58、中距離77、遠距離54と全距離で高い。ミサイルロック102、マルチロック66。EN負荷486と最高。全距離対応高性能型。',
