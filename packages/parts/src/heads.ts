...
export const heads = [
  defineHead({
    ...
    ai_summary: 'BAWS製ヘッド。AP1250、実弾防御191、爆発防御192と高め。姿勢安定370、システム復元84。スキャン距離340、効果時間14.4秒。バランス型。',
  ...
  defineHead({
    ...
    ai_summary: 'BAWS製ヘッド。AP1000、防御力は標準的。姿勢安定302、システム復元60と低め。スキャン距離400と長め。重量4250とやや軽量。価格0の初期装備。',
  ...
  defineHead({
    ...
    ai_summary: 'ベイラム製ヘッド。AP910、防御力はバランス良く標準的。姿勢安定430、システム復元115と高い。スキャン待機時間4.2秒と短い。重量3160と軽量。',
  ...
  defineHead({
    ...
    ai_summary: 'ベイラム製ヘッド。AP1080、三属性防御が185前後と完全にバランス。姿勢安定469、システム復元112と高い。スキャン距離510と長い。高性能バランス型。',
    ai_tags: ['ヘッド', '完全バランス防御', 'スキャン距離特化', 'ベイラム', '中量級'],
  }),
  defineHead({
    id: 'HD005',
    ...
    ai_summary: 'ベイラム製ヘッド。AP970、防御力は標準的。姿勢安定436、システム復元106。スキャン距離580、効果時間12秒と長い。価格0の初期装備。',
    ai_tags: ['ヘッド', '初期装備', 'スキャン効果時間特化', 'ベイラム', '軽量級'],
  }),
  defineHead({
    id: 'HD006',
    ...
    ai_summary: '大豊製ヘッド。AP320と極めて低く、防御力も低め。重量1230、EN負荷88と最軽量級。爆発防御184と相対的に高め。超軽量特化型。',
  ...
  defineHead({
    ...
    ai_summary: 'アーキバス製ヘッド。AP850、三属性防御が170前後とバランス良い。姿勢安定408、システム復元117と高い。スキャン距離520と長め。軽量バランス型。',
    ai_tags: ['ヘッド', 'バランス型', 'スキャン距離特化', 'アーキバス', '軽量級'],
  }),
  defineHead({
    id: 'HD008',
    ...
    ai_summary: 'アーキバス製ヘッド。AP880、EN防御183と高くEN武器に強い。姿勢安定496と高い。スキャン距離530、効果時間14.4秒と長い。高性能スキャン型。',
  ...
  defineHead({
    ...
    ai_summary: 'シュナイダー製ヘッド。AP590と低め、防御力も低め。重量2320と軽量。姿勢安定422、スキャン効果時間13.2秒と長い。EN負荷210と高め。軽量型。',
    ai_tags: ['ヘッド', '軽量級', 'スキャン効果時間特化', 'シュナイダー', '低防御'],
  }),
  defineHead({
    id: 'HD010',
    ...
    ai_summary: 'シュナイダー製ヘッド。AP400と低い、防御力も低め。姿勢安定498、システム復元128と最高クラス。スキャン距離620、待機時間3.6秒と極めて短い。スキャン特化型。',
    ai_tags: ['ヘッド', '最高システム復元', 'スキャン特化', 'シュナイダー', '軽量級'],
  }),
  defineHead({
    id: 'HD011',
    ...
    ai_summary: 'シュナイダー製ヘッド。AP300と最低レベル、防御力も最低クラス。重量1050と最軽量。システム復元121と高い。EN負荷220と高め。超軽量特化型。',
  ...
  defineHead({
    ...
    ai_summary: 'アーキバス先進開発局製ヘッド。AP1060、EN防御188と高くバランス良い防御力。姿勢安定413、システム復元110。スキャン距離490、効果時間12.6秒。高性能型。',
    ai_tags: ['ヘッド', '高性能型', '高EN防御', 'アーキバス先進開発局', '中量級'],
  }),
  defineHead({
    id: 'HD013',
    ...
    ai_summary: 'アーキバス先進開発局製ヘッド。AP1040、EN防御181と高い。姿勢安定435、システム復元154と最高クラス。スキャン距離700、効果時間18秒と極めて長い。最高性能スキャン型。',
    ai_tags: ['ヘッド', '最高スキャン性能', '最高システム復元', 'アーキバス先進開発局', '中量級'],
  }),
  defineHead({
    id: 'HD014',
    ...
    ai_summary: 'RaD製ヘッド。AP660、防御力は低め。姿勢安定346、システム復元102。スキャン待機時間3.6秒と極めて短い。重量2670、EN負荷125と軽量。価格0の初期装備。',
  ...
  defineHead({
    ...
    ai_summary: 'RaD製ヘッド。AP770、防御力は標準的。姿勢安定448、システム復元120と高い。スキャン距離450、効果時間10.8秒。重量3090と軽量。バランス型。',
  ...
  defineHead({
    ...
    ai_summary: 'RaD製ヘッド。AP1130と高く、実弾防御200と最高クラス。姿勢安定322、システム復元75と低め。スキャン性能は低い。EN負荷102と低い。実弾防御特化型。',
  ...
  defineHead({
    ...
    ai_summary: 'RaD製ヘッド。AP760、三属性防御が176-180とバランス良い。姿勢安定376、システム復元93。スキャン距離610と長い。重量3000、EN負荷103と軽量。バランス型。',
  ...
  defineHead({
    ...
    ai_summary: 'エルカノ製ヘッド。AP480と低め、三属性防御が154-158と完全にバランス。姿勢安定398、スキャン効果時間15秒と長い。重量2570と軽量。軽量バランス型。',
    ai_tags: ['ヘッド', '完全バランス防御', 'スキャン効果時間特化', 'エルカノ', '軽量級'],
  }),
  defineHead({
    id: 'HD019',
    ...
    ai_summary: 'エルカノ製ヘッド。AP600、三属性防御が全て171と完全にバランス。姿勢安定414、システム復元111と高い。スキャン距離500と長め。重量2800と軽量。完全バランス型。',
    ai_tags: ['ヘッド', '完全バランス防御', 'スキャン距離特化', 'エルカノ', '軽量級'],
  }),
  defineHead({
    id: 'HD020',
    ...
    ai_summary: 'オールマインド製ヘッド。AP820、EN防御186と高くバランス良い防御力。姿勢安定395、システム復元109。スキャン待機時間4.8秒と短い。バランス型。',
  ...
  defineHead({
    ...
    ai_summary: 'オールマインド製ヘッド。AP520と低め、防御力も低め。姿勢安定536と最高クラス。スキャン距離540、効果時間12秒と長い。EN負荷128と低い。姿勢安定特化型。',
    ai_tags: ['ヘッド', '最高姿勢安定', 'スキャン性能特化', 'オールマインド', '低EN負荷'],
  }),
  defineHead({
    id: 'HD022',
    ...
    ai_summary: '技研製ヘッド。AP990、EN防御189と高くバランス良い防御力。姿勢安定480、システム復元132と最高クラス。スキャン距離550と長い。高性能型。',
  ...
  defineHead({
    ...
    ai_summary: '技研製ヘッド。AP930、EN防御182と高くバランス良い防御力。姿勢安定451、システム復元125と高い。スキャン距離600、効果時間16.8秒と極めて長い。高性能スキャン型。',
