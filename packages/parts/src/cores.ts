...
export const cores = [
  defineCore({
    ...
    ai_summary:
      'BAWS製コア。AP3580、実弾防御435、爆発防御460と高め。姿勢安定476、ブースター効率119と高い。ジェネレータ出力83と低め。バランス型。',
  ...
  defineCore({
    ...
    ai_summary:
      'BAWS製コア。AP2400と低め、重量12350と軽量。姿勢安定403、ブースター効率119と高い。ジェネレータ出力83と低め。価格0の初期装備。軽量高機動型。',
  ...
  defineCore({
    ...
    ai_summary:
      'ベイラム製コア。AP3230、実弾防御438と高め。姿勢安定458、ジェネレータ出力105、供給97。EN負荷304と低め。バランス型。',
  ...
  defineCore({
    ...
    ai_summary:
      'ベイラム製コア。AP2830、重量14050と軽量。姿勢安定433、ブースター効率103、ジェネレータ出力102、供給103と全て標準的。価格0の初期装備。',
  ...
  defineCore({
    ...
    ai_summary:
      '大豊製コア。AP4100と極めて高く、実弾防御473、EN防御438、爆発防御478と最高クラス。姿勢安定629と極めて高い。重量級向け。重装甲タンク型。',
  ...
  defineCore({
    ...
    ai_summary:
      'アーキバス製コア。AP3160、EN防御436と高くEN武器に強い。姿勢安定446、ブースター効率102、ジェネレータ出力106、供給102。バランス型。',
  ...
  defineCore({
    ...
    ai_summary:
      'シュナイダー製コア。AP2630、防御力は低め。重量9820と最軽量級。ブースター効率126と極めて高く、EN供給109も高い。超軽量高機動型。',
    ai_tags: [
      'コア',
      '最軽量級',
      '最高ブースター効率',
  ...
  defineCore({
    ...
    ai_summary:
      'シュナイダー製コア。AP2470と最低レベル、重量9700と最軽量。ジェネレータ出力117、供給110と極めて高い。EN出力特化の超軽量型。',
    ai_tags: [
      'コア',
      '最軽量級',
      '最高ジェネレータ出力',
  ...
  defineCore({
    ...
    ai_summary:
      'アーキバス先進開発局製コア。AP4320と最高クラス、EN防御495と極めて高い。姿勢安定521、ジェネレータ出力122と最高クラス。超重量級高性能型。',
    ai_tags: [
      'コア',
      '最高AP',
      '最高EN防御',
  ...
  defineCore({
    ...
    ai_summary:
      'RaD製コア。AP2780、重量12650と軽量。ブースター効率100、ジェネレータ出力103、供給93と標準的。EN負荷267と最低クラス。価格0の初期装備。',
  ...
  defineCore({
    ...
    ai_summary:
      'RaD製コア。AP3940と高く、実弾防御468、爆発防御461と高い。姿勢安定532と高い。重量19000と重め。EN負荷310と低め。重量級向けバランス型。',
  ...
  defineCore({
    ...
    ai_summary:
      'RaD製コア。AP3890、EN防御489と極めて高い。姿勢安定641と最高クラス。EN供給112と高い。重量23600と最重量級。超重量級EN防御特化型。',
  ...
  defineCore({
    ...
    ai_summary:
      'エルカノ製コア。AP2500、防御力は低め。重量10890と軽量。ブースター効率111、ジェネレータ出力104と高め。軽量高機動型。',
  ...
  defineCore({
    ...
    ai_summary:
      'エルカノ製コア。AP2850、三属性防御が全て370と完全にバランス。重量12000と軽量。ブースター効率115、EN供給105と高い。軽量バランス型。',
    ai_tags: [
      'コア',
      '完全バランス防御',
      'ブースター効率特化',
  ...
  defineCore({
    ...
    ai_summary:
      'オールマインド製コア。AP3520、EN防御455と高くバランス良い防御力。姿勢安定455、ジェネレータ出力112、供給104と高い。高性能バランス型。',
  ...
  defineCore({
    ...
    ai_summary:
      '技研製コア。AP2710、防御力は低め。重量13200と軽量。ジェネレータ出力126と最高クラス。EN負荷412と高め。EN出力特化の軽量型。',
  ...
  defineCore({
    ...
    ai_summary:
      '技研製コア。AP3670、EN防御469と極めて高くバランス良い防御力。ジェネレータ出力120、供給108と極めて高い。高性能EN特化型。',
