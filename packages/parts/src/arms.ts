...
export const arms = [
  defineArms({
    ...
    ai_summary:
      'BAWS社製の中量級腕部パーツ。近接特化158と高い近接適性。反動制御66、腕部積載10520と標準的。重量10480とバランス良く、EN負荷210と軽め。',
  ...
  defineArms({
    ...
    ai_summary:
      'BAWS社製の軽量型腕部パーツ。AP1000と低耐久、近接特化112。反動制御45、射撃適性45と低め。重量8480と軽量で、EN負荷210と低い。',
  ...
  defineArms({
    ...
    ai_summary:
      'ベイラム社製の重量級腕部パーツ。腕部積載15100、反動制御128と高い。射撃適性100、近接特化108とバランス型。重量13650、EN負荷265と標準的。',
    ai_tags: [
      '腕部',
      '重量級',
      '高積載',
  ...
  defineArms({
    ...
    ai_summary:
      'ベイラム社製の射撃特化型腕部パーツ。射撃適性135と高く、反動制御102。腕部積載12000、重量12000と軽量化。EN負荷232と低め。',
    ai_tags: [
      '腕部',
      '射撃特化',
      '中量級',
  ...
  defineArms({
    ...
    ai_summary:
      '大豊社製の超重量級腕部パーツ。腕部積載19500と最高クラス、反動制御155と高い。高い防御力とバランスの取れた適性。重量20020と超重量級。',
  ...
  defineArms({
    ...
    ai_summary:
      '大豊社製の最重量級腕部パーツ。AP3070と最高クラス、対運動防御305と極めて高い。反動制御145、腕部積載17200。重量26740と最重量級。',
    ai_tags: [
      '腕部',
      '最重量級',
      '最高AP',
  ...
  defineArms({
    ...
    ai_summary:
      'アーキバス社製の中量級腕部パーツ。対エネルギー防御252と高く、バランスの取れた適性。反動制御116、腕部積載14520。重量14020、EN負荷278。',
    ai_tags: [
      '腕部',
      '中量級',
      '対エネルギー特化',
  ...
  defineArms({
    ...
    ai_summary:
      'アーキバス社製の射撃特化型腕部パーツ。射撃適性133と高く、反動制御105。AP1620と低め。重量10990と軽量、EN負荷248と低め。',
  ...
  defineArms({
    ...
    ai_summary:
      'シュナイダー社製の射撃特化型腕部パーツ。射撃適性160と極めて高く、反動制御87。腕部積載12730。重量11420、EN負荷290と標準的。',
    ai_tags: [
      '腕部',
      '射撃特化',
      '中量級',
  ...
  defineArms({
    ...
    ai_summary:
      'シュナイダー社製の軽量型腕部パーツ。反動制御134と高く、対エネルギー防御246。重量9700と軽量だが、EN負荷328と高め。AP1590と低耐久。',
    ai_tags: [
      '腕部',
      '軽量級',
      '高反動制御',
  ...
  defineArms({
    ...
    ai_summary:
      'アーキバス先進開発局の超重量級腕部パーツ。腕部積載21300と最高クラス、反動制御170と極めて高い。AP2860、高い防御力。重量22210、EN負荷380と高め。',
    ai_tags: [
      '腕部',
      '超重量級',
      '最高積載',
  ...
  defineArms({
    ...
    ai_summary:
      'RaD製の汎用型腕部パーツ。バランスの取れた性能、反動制御110、腕部積載13300。重量11300、EN負荷216と軽め。価格0の初期装備。',
  ...
  defineArms({
    ...
    ai_summary:
      'RaD製の反動制御特化型腕部パーツ。反動制御232と最高クラス。射撃適性26、近接特化43と低め。腕部積載15800。重量14150、EN負荷220と低め。',
    ai_tags: [
      '腕部',
      '反動制御特化',
      '中量級',
  ...
  defineArms({
    ...
    ai_summary:
      'RaD製の超重量級腕部パーツ。AP2600、高い防御力、腕部積載18700。反動制御140、バランスの取れた適性。重量20940、EN負荷324。',
  ...
  defineArms({
    ...
    ai_summary:
      'エルカノ社製の射撃特化型腕部パーツ。射撃適性122と高く、反動制御111。腕部積載13540、バランスの取れた性能。重量11220と軽量、EN負荷270。',
    ai_tags: [
      '腕部',
      '射撃特化',
      '軽量級',
  ...
  defineArms({
    ...
    ai_summary:
      'エルカノ社製の射撃特化型軽量腕部パーツ。射撃適性140と極めて高く、全防御205と均等。重量9810と最軽量級、EN負荷315。AP1750と低耐久。',
    ai_tags: [
      '腕部',
      '射撃特化',
      '最軽量級',
  ...
  defineArms({
    ...
    ai_summary:
      'オールマインド社製の重量級腕部パーツ。反動制御142、腕部積載15550。対エネルギー防御260と高く、バランスの取れた性能。重量16960、EN負荷358。',
    ai_tags: [
      '腕部',
      '重量級',
      '高反動制御',
  ...
  defineArms({
    ...
    ai_summary:
      '技研製の中量級腕部パーツ。対エネルギー防御263と高く、バランスの取れた適性。反動制御108、腕部積載12680。重量12700、EN負荷312。',
    ai_tags: [
      '腕部',
      '中量級',
      '対エネルギー特化',
  ...
  defineArms({
    ...
    ai_summary:
      '技研製の中量級腕部パーツ。射撃適性123と高く、反動制御125。腕部積載14000、対エネルギー防御248。重量14160、EN負荷300と標準的。',
    ai_tags: [
      '腕部',
      '射撃特化',
      '中量級',
