...
export const expansions = [
  defineExpansion<AsAssaultArmor>({
    ...
    ai_summary:
      'アサルトアーマー。攻撃力1500、衝撃力2000、蓄積衝撃1380。爆発半径60、有効範囲200。近距離全方位攻撃で敵を吹き飛ばす緊急回避技。',
    ai_tags: [
      '拡張機能',
      'アサルトアーマー',
      '全方位攻撃',
  ...
  defineExpansion<AsProtect>({
    ...
    ai_summary:
      'パルスアーマー。耐久値3300、持続時間10秒。全方位バリアで一定時間ダメージを軽減。衝撃も無効化する。標準的な防御拡張。',
    ai_tags: [
      '拡張機能',
      'パルスアーマー',
      '全方位バリア',
  ...
  defineExpansion<AsProtect>({
    ...
    ai_summary:
      'パルスプロテクション。耐久値4000、持続時間25秒。バリアの強化版で耐久値と持続時間が大幅に向上。長時間の戦闘に有利。',
    ai_tags: [
      '拡張機能',
      'パルスプロテクション',
      '長時間バリア',
  ...
  defineExpansion<AsProtect>({
    ...
    ai_summary:
      'ターミナルアーマー。耐久値20000と極めて高く、持続時間2秒と短い。瞬間的に超高耐久バリアを展開。決定的な攻撃を防ぐ緊急防御技。',
    ai_tags: [
      '拡張機能',
      'ターミナルアーマー',
      '超高耐久バリア',
