<script lang="ts">
  ...
  const sections = [
    ...
    },
    {
      ...
      items: [
        ...
        '言語設定や表示オプションなど、ユーザー体験向上のためのクッキー / localStorage データ',
        'エラーログ（個人を特定しない形の構造化ログのみ）',
      ],
    },
    {
      id: 'purpose',
  ...
  const languageSwitcher = [
    { label: '日本語', href: '/privacy/ja', active: true },
    { label: 'English', href: '/privacy/en', active: false },
  ] as const
</script>
