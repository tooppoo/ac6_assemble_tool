...
export const aboutSections: readonly AboutSection[] = [
  ...
  },
  {
    ...
    body: [
      ...
      'フィルタリング機能は現在、製造企業と攻撃属性の条件に対応しています。細かなステータス条件やキーワード検索にはまだ対応していませんが、将来的に重量・消費 EN・攻撃種別などの詳細なフィルタリングやソーティングを提供できるよう開発を進めています。それまではロック機能やランダム機能を組み合わせ、利用者自身がテーマを決めて候補を絞り込む手法を推奨しています。',
    ],
  },
  {
    id: 'data-governance',
