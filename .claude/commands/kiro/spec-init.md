...
**Check existing `docs/specs/` directory to ensure the generated feature name is unique. If a conflict exists, append a number suffix (e.g., feature-name-2).**

### 2. Create Spec Directory
Create `docs/specs/[generated-feature-name]/` directory with:
